...
// public:
//   template <class... Ts>
//   datagram_transport(udp_datagram_socket handle, multiplexer* mpx, Ts&&...
//   xs)
...
//       for (size_t i = 0;
//            application_.has_more_data() && (i < max_consecutive_fetches);
//            ++i)
...
//                              util::format("[datagram_transport::write()]
//                              {0}",
//                                           last_socket_error_as_string())));
//           return event_result::error;
//         }
