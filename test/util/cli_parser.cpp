...
TEST(cli_parser, add_option) {
  {
    cli_parser parser;
    ASSERT_NO_THROW(parser.add_option(id_opt1.data(), "opt1", 'o', false));
    ASSERT_NO_THROW(parser.add_option(id_opt2.data(), "opt2", 'p', false));
    ASSERT_NO_THROW(parser.add_option(id_opt3.data(), "opt3", 'q', false));
  }
  {
    cli_parser parser;
    ASSERT_NO_THROW(parser.add_option(id_opt1.data(), "opt1", 'o', false)
                      .add_option(id_opt2.data(), "opt2", 'p', false)
                      .add_option(id_opt3.data(), "opt3", 'q', false));
  }
  {
    cli_parser parser;
    ASSERT_NO_THROW(parser.add_option(id_opt1.data(), "opt1", 'o', false));
    ASSERT_THROW(parser.add_option(id_opt1.data(), "opt2", 'p', false),
                 std::runtime_error);
  }
  {
    cli_parser parser;
    ASSERT_NO_THROW(parser.add_option(id_opt1.data(), "opt1", 'o', false));
    ASSERT_THROW(parser.add_option(id_opt2.data(), "opt1", 'p', false),
                 std::runtime_error);
  }
  {
    cli_parser parser;
    ASSERT_NO_THROW(parser.add_option(id_opt1.data(), "opt1", 'o', false));
    ASSERT_THROW(parser.add_option(id_opt2.data(), "opt2", 'o', false),
                 std::runtime_error);
  }
  {
    cli_parser parser;
    ASSERT_THROW(parser.add_option(id_opt1.data(), cli_parser::no_longform,
                                   cli_parser::no_shortform, false),
                 std::runtime_error);
  }
  {
    cli_parser parser;
    ASSERT_NO_THROW(parser.add_option(id_opt1.data(), "longform", 's', false));
    ASSERT_THROW(parser.add_option(id_opt1.data(), "longform", 's', false),
                 std::runtime_error);
  }
}

TEST(cli_parser, parse) {
  {
    cli_parser parser;
    ASSERT_NO_THROW(parser.add_option(id_opt1.data(), "option", 'o', false));
  ...
  {
    cli_parser parser;
    ASSERT_NO_THROW(parser.add_option(id_opt1.data(), "option", 'o', true));
  ...
  }
  {
    cli_parser parser;
    ASSERT_NO_THROW(parser.add_option(id_opt1.data(), "option", 'o', true));
    std::vector<const char*> args{"./program", "--option", "argument1", "-o",
                                  "argument2"};
    ASSERT_NO_THROW(parser.parse(args));
    EXPECT_EQ(parser.program_name(), "./program"sv);
    EXPECT_TRUE(parser.contains_option(id_opt1.data()));
...
TEST(cli_parser, option_value_conversion) {
  ...
  // Converting to unsupported type
  {
    cli_parser parser;
    ASSERT_NO_THROW(parser.add_option(id_opt1.data(), "option", 'o', true));
    std::vector<const char*> args{"./program", "--option", "hello", "-o",
                                  "other"};
    ASSERT_NO_THROW(parser.parse(args));
    EXPECT_EQ(parser.program_name(), "./program"sv);
    EXPECT_TRUE(parser.contains_option(id_opt1.data()));
