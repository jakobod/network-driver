...
#include "net/sockets/socket_guard.hpp"

#include "net/sockets/stream_socket.hpp"
...
struct socket_guard_test : public testing::Test {
  socket_guard_test()
    : sockets{sockets::stream_socket{sockets::invalid_socket_id},
              sockets::stream_socket{sockets::invalid_socket_id}} {
    auto socket_res = sockets::make_stream_socket_pair();
